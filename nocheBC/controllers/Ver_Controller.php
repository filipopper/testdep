...
class Ver_Controller extends Controller
{
    ...
    public function todosLosArticulos($param)
    {
        $id = $param[0];
        //echo "b";
        $nombre                   = "Nicolas";
        $this->view->variable_ver = "ni nombre es $nombre";
        $model                    = new Pedidos_Model();
        $lista                    = $model->mostrarPedidos($id);
        $this->view->lista        = $lista;
        $this->view->render('ver/todosLosArticulos');
        //$alumnos = $this->model->get();
        //$this->view->mensaje = "cargado";
        //$this->view->render('articulos/index');
    }
